...
export POSTGRESQL_PASSWORD_FILE="${POSTGRESQL_PASSWORD_FILE:-"${POSTGRES_PASSWORD_FILE:-}"}"
export POSTGRESQL_PASSWORD_FILE="${POSTGRESQL_PASSWORD_FILE:-}"
...
export POSTGRESQL_POSTGRES_PASSWORD_FILE="${POSTGRESQL_POSTGRES_PASSWORD_FILE:-"${POSTGRES_POSTGRES_PASSWORD_FILE:-}"}"
export POSTGRESQL_POSTGRES_PASSWORD_FILE="${POSTGRESQL_POSTGRES_PASSWORD_FILE:-}"
